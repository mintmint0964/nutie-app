    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        webView.webViewClient = object : WebViewClient() {
            override fun shouldOverrideUrlLoading(view: WebView, request: WebResourceRequest): Boolean {
                val uri = request.url
                return if (uri.host == "nutieschool.kr" || uri.host?.endsWith(".nutieschool.kr") == true) false
        ...
        if (savedInstanceState == null) webView.loadUrl("https://nutieschool.kr/") else webView.restoreState(savedInstanceState)
    }
